...
export function TalkGPTA2({ finish }: TalkGPTA2) {
  ...
  return (
    <div>
      <p>
      Some genius prompt-engineered a model inversion attack against your chatbot.
      Now Reddit has screenshots of “you” revealing embarrassing things about you and your friends!
      </p>
      <p>
